...
public class ResourceBundle extends java.util.ResourceBundle {
    ...
    public ResourceBundle() {
        String messageBundleName = "MessagesBundle";
        setParent(java.util.ResourceBundle.getBundle(messageBundleName, FacesContext.getCurrentInstance().getViewRoot().getLocale(), UTF8_CONTROL));
    }
